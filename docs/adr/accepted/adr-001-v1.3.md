# ADR-001 v1.3: The "Agentic-First" Architecture for Life Sciences Integration

**Status:** APPROVED FOR CONSTRUCTION (Final)
**Date:** 2026-01-09
**Version:** 1.3 (Final Construction Document)
...
- v1.3: Added `ucsc` and `pubmed` to Core Identifiers registry to support CrossReferences refactor.
...
*For developer reference during construction.*

### Phase 1: Foundation
- [ ] Implement `LifeSciencesClient` with async `httpx`
- [ ] Define Pydantic models for Agentic Biolink schema
- [ ] Implement Canonical Pagination Envelope
- [ ] Implement Canonical Error Envelope
- [ ] Build HGNC MCP server with Fuzzy-to-Fact protocol

### Phase 2: Drug Discovery Core
- [ ] Implement Open Targets GraphQL client
- [ ] Implement ChEMBL wrapper with `run_in_executor`
- [ ] Add `slim=True` parameter to all batch tools
- [ ] Validate cross-reference regex patterns

### Phase 3+: Extended Coverage
- [ ] Implement remaining Tier 1-4 API wrappers
- [ ] Populate cross-references for all entity types
- [ ] Integration testing for Triangulation protocol
...
| Maintenance | Antigravity | 2026-01-09 | Amended v1.3 |
